...
(
    task_list_id bigint generated by default as identity,
...
alter table to_do_task
    add constraint FKo0tholkquejg2l5phe7tcx2np foreign key (task_list) references task_list on delete cascade;